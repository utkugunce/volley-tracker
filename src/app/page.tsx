...
export async function generateMetadata({ searchParams }: PageProps): Promise<import("next").Metadata> {
  ...
  let title = "TVF Voleybol İl Temsilciliği — Fikstür ve Puan Durumu | TVFSCORE";
