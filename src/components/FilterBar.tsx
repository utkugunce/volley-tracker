          ...
          {onSelectVolleyboxFilter && (
            <div className="flex items-center bg-slate-900/80 border border-slate-800 rounded-xl p-0.5 text-xs" role="group" aria-label="Volleybox veri eşleşme filtresi">
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[11px] font-semibold transition-all flex items-center gap-1 focus:outline-none focus-visible:ring-1 focus-visible:ring-slate-400 ${
              ...
              {volleyboxStats && (volleyboxStats.discrepancy ?? 0) > 0 && (
                ...
                >
                  <AlertTriangle size={11} aria-hidden="true" className={volleyboxFilter === "discrepancy" ? "text-white" : "text-amber-400"} />
                  <span>Değişenler</span>
                  <span className={`text-[10px] font-mono ${volleyboxFilter === "discrepancy" ? "text-amber-100" : "text-amber-400 font-bold"}`}>
